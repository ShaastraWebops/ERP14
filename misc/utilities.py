...
def facilities_check (user):
    return user.get_profile().dept.name == "Facilities"
...
def finance_or_events_check (user):
    return user.get_profile().dept.name == "Finance" or user.get_profile().dept.name == "Events"
